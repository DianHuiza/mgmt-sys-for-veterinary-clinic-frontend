...
export const Header: React.FC = () => {
  return (
    <header className='flex items-center justify-between bg-white px-8 bg-gray-100 sticky top-0 w-full shadow-md shadow-platinum-100'>
      ...
      <div className='flex items-center'>
        ...
        <NavigationLink to='/appointments'>Turnos</NavigationLink>
